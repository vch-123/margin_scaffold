...
using TheMarginalScaffold.Service.BackService;
    ...
    public static IHostBuilder CreateHostBuilder(string[] args)
    {
        return Host.CreateDefaultBuilder(args)
           .ConfigureServices((hostContext, services) =>
           {
               ...
               services.AddSingleton<DataConverterService>();
               services.AddSingleton<CommandService>();
               services.AddSingleton<CommandQueueService>();
               services.AddSingleton<MqttClient>();
               services.AddSingleton<UDPClient>();

               services.AddHostedService<RealTimeSendCraneCommandBackgroundService>();
               ...
               services.AddHostedService<CtrlHeartBeatBackgroundService>();
